    ...
    <>
      ...
      >
        ...
        {isMobile && presenterId ? null : (
          ...
          >
            <div style={{color:'white'}}>Disclaimer: This video call is only for the initial verification and validation of the product and services that you are availing through ClientName</div>
            <div
              style={{
                height:
                  (presenterId
